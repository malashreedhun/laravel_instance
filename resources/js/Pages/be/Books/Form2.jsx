            ...
            <div className="m-5 p-5 flow-root shadow sm:rounded-lg">
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className={`grid grid-cols-2 gap-4 py-4`}>
                        <div>
                            <InputLabel htmlFor="title" value="IRA ACCOUNT NUMBER"
                        ...
                        <div>
                            <InputLabel htmlFor="ISBN_10" value="CUSTODIAN NAME"
                                        className="block text-sm font-medium leading-6 text-gray-900"/>
                            <div className="mt-2">
                                <TextInput
                                    id="ISBN_10"
                                    name="ISBN_10"
                                    type={'text'}
                                    placeholder={'Enter your custodian name'}
                                    value={data.ISBN_10}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        ...
                        <div>
                            <InputLabel htmlFor="ISBN_13" value="CUSTPDIAN STREET ADDRESS"
                                        className="block text-sm font-medium leading-6 text-gray-900"/>
                            <div className="mt-2">
                                <TextInput
                                    id="ISBN_13"
                                    name="ISBN_13"
                                    type={'text'}
                                    placeholder={'Enter your custodian\'S street address'}
                                    value={data.ISBN_13}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        ...
                        <div>
                            <InputLabel htmlFor="ISBN_13" value="CITY"
                                        className="block text-sm font-medium leading-6 text-gray-900"/>
                            <div className="mt-2">
                                <TextInput
                                    id="ISBN_13"
                                    name="ISBN_13"
                                    type={'text'}
                                    placeholder={'Enter your custodian\'S city'}
                                    value={data.ISBN_13}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autoComplete="ISBN_13"
                                    isFocused={true}
                        ...
                        <div>
                            <InputLabel htmlFor="ISBN_13" value="STATE"
                                        className="block text-sm font-medium leading-6 text-gray-900"/>
                            <div className="mt-2">
                                <TextInput
                                    id="ISBN_13"
                                    name="ISBN_13"
                                    type={'text'}
                                    placeholder={'Enter your custodian\'S state'}
                                    value={data.ISBN_13}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autoComplete="ISBN_13"
                                    isFocused={true}
                        ...
                        <div>
                            <InputLabel htmlFor="ISBN_13" value="ZIP CODE"
                                        className="block text-sm font-medium leading-6 text-gray-900"/>
                            <div className="mt-2">
                                <TextInput
                                    id="ISBN_13"
                                    name="ISBN_13"
                                    type={'text'}
                                    placeholder={'Enter your custodian\'S zip code'}
                                    value={data.ISBN_13}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autoComplete="ISBN_13"
                                    isFocused={true}
                    ...
                    <div className="flex items-center justify-end align-middle gap-2 pt-3 border-t">
                        <Link
                            href={route('/resources/js/Pages/be/Books/Form.jsx')}
